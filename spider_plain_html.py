...
search_list = ["左传", "吕氏春秋", "列子", "孙子兵法", "墨子", "淮南子", "庄子", "韩非子", "老子", "史通", "战国策", "史记", "山海经", "中庸", "孟子", "论语", "孝经", "礼记", "周礼", "诗经", "周易", "金刚经", "心经", "维摩诘经", "六祖坛经", "楞严经", "法华经", "华严经", "了凡四训"]
                ...
                for text in text_soup.select('.contson'):
                    ...
                    for p in text:
                        if p.string and p.string.strip():
                            paragraphs = paragraphs + "<p>" + p.string.strip() + "</p>\n"
